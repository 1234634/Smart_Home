...
MQTT_C_APP = bin/kontroler bin/senzorski_pi bin/aktuatorski_pi bin/command_line_interface
...
bin/command_line_interface: src/command_line_interface.c $(MQTT_C_SOURCES)
	$(CC) $(CFLAGS) $^ -pthread -o $@
